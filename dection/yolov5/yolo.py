...
class YOLO(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.classes_path="F:/Project/ObjectDetection-Platform-master/yolov5/model_data/river_garbage_classes.txt"
        self.anchors_path ="F:/Project/ObjectDetection-Platform-master/yolov5/model_data/yolo_anchors.txt"
        #---------------------------------------------------#
        #   获得种类和先验框的数量
        #---------------------------------------------------#
    ...
    def generate(self, onnx=False):
        ...
        #---------------------------------------------------#
        self.model_path="F:/Project/ObjectDetection-Platform-master/yolov5/model_data/best.pth"
